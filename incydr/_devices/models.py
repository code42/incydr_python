...
class Device(ResponseModel):
    device_id: Optional[str] = Field(
        allow_mutation=False, alias="deviceId", description='A globally unique ID (guid) for this device.'
    )
    ...
    os_hostname: Optional[str] = Field(
        allow_mutation=False, alias="osHostname", description="Device Hostname according to the device's OS."
    )
    ...
    active: Optional[bool] = Field(
        allow_mutation=False, description='True means the device will show up on reports, etc.'
    )
    ...
    alert_state: Optional[int] = Field(
        allow_mutation=False, alias="alertState", description='0=ok, 1=connection warning, 2=connection critical'
    )
    user_id: Optional[str] = Field(
        allow_mutation=False, alias="userId", description='A globally unique ID for this user.'
    )
    ...
    org_guid: Optional[str] = Field(
        allow_mutation=False,
        alias="orgGuid",
        description="The globally unique org ID."
    )
    ...
    os_version: Optional[str] = Field(
        allow_mutation=False, alias="osVersion", description='Operating system version. Values: 10.5.1, 6.2, etc'
    )
    os_arch: Optional[str] = Field(
        allow_mutation=False, alias="osArch", description='Hardware architecture. Values: i386, amd64, sparc, x86, etc'
    )
    address: Optional[str] = Field(
        allow_mutation=False, description='Internal IP address and port. Example: 192.168.42.1:4282'
    )
    remote_address: Optional[str] = Field(
        allow_mutation=False, alias="remoteAddress", description='External IP address and port. Example: 171.22.110.41:13958'
    )
    time_zone: Optional[str] = Field(
        allow_mutation=False, alias="timeZone", description='Examples: Australia/Canberra, Asia/Calcutta'
    )
