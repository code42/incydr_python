...
from _cli.cmds.options.audit_log_filter_options import filter_options
...
from _client.audit_log.models import DateRange
from _client.audit_log.models import QueryAuditLogRequest
